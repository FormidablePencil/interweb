...
public class CarouselOfImagesRepositoryTest() : BehaviorSpecUtRepo() {
  init {
    // region Setup
    ...
    suspend fun signup_then_createComposition(publicView: Boolean): Triple<Int, Int, Int> { 
      ...
      val compositionSourceId = carouselCompositionsFlow.createComposition(publicView, layoutId,
        authorId)
    ...
    given("getPublicComposition") {
      ...
      then("successfully got public composition") {
        rollback {
          ...
          comp.imgOnclickRedirects.size shouldBe
              carouselBasicImagesCreateReq.imgOnclickRedirects.size
    ...
    given("compose") {suspend fun prepareComposition(): CarouselOfImagesComposePrepared {
                      val authorId = signupFlow.signupReturnId()
    ...
    given("deleteComposition") {suspend fun prepareComposition(): CarouselOfImagesComposePrepared {
          val authorId = signupFlow.signupReturnId()
          val createRequest = CarouselBasicImagesCreateReq(
              name = "that was legitness",
              images = listOf(),
      ...
      then("success") {
        rollback {
          ...
          resBeforeDeletion.imgOnclickRedirects.size shouldBe
              carouselBasicImagesCreateReq.imgOnclickRedirects.size
